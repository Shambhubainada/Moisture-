const CACHE='fsd-sabarmati-v4';
const ASSETS=['./','./index.html','./manifest.webmanifest','./farmer_dvara_farming.gif','./icon-192.png','./icon-512.png','./FSD_Sabarmati_Stack_Moisture.html'];
